              ...
              <div>
                  ...
                  <div className="mt-1 grid grid-cols-2 gap-3">
                    <div>
                      ...
                      >
                        ...
                        <svg className="w-5 h-5 text-blue-500" aria-hidden="true" fill="currentColor" viewBox="0 0 20 20">
                          <path
                            fillRule="evenodd"
                ...
                <div className="mt-6 relative">
                  ...
                  <div className="relative flex justify-center text-sm">
                    <span className="px-2 bg-primaryColor text-white">Or continue with</span>
                  </div>
                </div>
              </div>
